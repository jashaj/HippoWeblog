  ...
  /*--------------------------------------:noTabs=true:tabSize=2:indentSize=2:--
    ...
    --  $LastChangedDate: 2010-03-09 21:48:01 +0100 (Tue, 09 Mar 2010) $
...
Xinha.version =
{
  ...
  'Date'      : '$LastChangedDate: 2010-03-09 21:48:01 +0100 (Tue, 09 Mar 2010) $'.replace(/^[^:]*:\s*([0-9\-]*) ([0-9:]*) ([+0-9]*) \((.*)\)\s*\$/, '$4 $2 $3'),
  'Revision'  : '$LastChangedRevision: 1248 $'.replace(/^[^:]*:\s*(.*)\s*\$$/, '$1'),
  'RevisionBy': '$LastChangedBy: wymsy $'.replace(/^[^:]*:\s*(.*)\s*\$$/, '$1')
};
 ...
 * @version $Rev: 1248 $ $LastChangedDate: 2010-03-09 21:48:01 +0100 (Tue, 09 Mar 2010) $
 * @constructor
